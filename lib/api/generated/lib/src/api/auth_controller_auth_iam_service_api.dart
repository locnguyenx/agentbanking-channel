...
class AuthControllerAuthIamServiceApi {

  final Dio _dio;

  final Serializers _serializers;

  const AuthControllerAuthIamServiceApi(this._dio, this._serializers);
  ...
  Future<Response<TokenResponse>> authenticateUser({ 
  ...
  Future<Response<void>> revokeToken({ 
    ...
    final _path = r'/api/v1/auth/revoke';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(revokeTokenRequest, specifiedType: _type);
