...
class OnboardingControllerOnboardingServiceApi {
  ...
  Future<Response<BuiltMap<String, JsonObject>>> getKycReviewQueue({ 
    ...
    final _path = r'/api/v1/backoffice/kyc/review-queue';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ApplicationSubmitResponse>> submitApplicationLegacy({ 
    ...
    ApplicationSubmitResponse? _responseData;
    ...
    return Response<ApplicationSubmitResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<KycVerifyResponse>> verifyMyKad({ 
    ...
    final _path = r'/api/v1/onboarding/verify-mykad';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    KycVerifyResponse? _responseData;
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltMap<String, JsonObject>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, JsonObject>>> verifyMyKadKyc({ 
    required BuiltMap<String, String> requestBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/kyc/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
