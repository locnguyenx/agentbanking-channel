...
class MerchantControllerLedgerServiceApi {
  ...
  Future<Response<CashBackResponse>> processCashBack({ 
    ...
    final _path = r'/api/v1/retail/cashback';
    ...
    CashBackResponse? _responseData;
    ...
    return Response<CashBackResponse>(
      data: _responseData,
  ...
  Future<Response<PinPurchaseResponse>> processPinPurchase({ 
    ...
    final _path = r'/api/v1/retail/pin-purchase';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PinPurchaseResponse? _responseData;
    ...
    return Response<PinPurchaseResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RetailSaleResponse>> processRetailSale({ 
    ...
    final _path = r'/api/v1/retail/sale';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RetailSaleResponse? _responseData;
    ...
    return Response<RetailSaleResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
