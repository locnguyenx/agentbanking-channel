...
const FeeConfigRequestAgentTierEnum _$feeConfigRequestAgentTierEnum_MICRO =
    const FeeConfigRequestAgentTierEnum._('MICRO');
const FeeConfigRequestAgentTierEnum _$feeConfigRequestAgentTierEnum_STANDARD =
    const FeeConfigRequestAgentTierEnum._('STANDARD');
const FeeConfigRequestAgentTierEnum _$feeConfigRequestAgentTierEnum_PREMIER =
    const FeeConfigRequestAgentTierEnum._('PREMIER');

FeeConfigRequestAgentTierEnum _$feeConfigRequestAgentTierEnumValueOf(
    String name) {
  switch (name) {
    case 'MICRO':
      return _$feeConfigRequestAgentTierEnum_MICRO;
    case 'STANDARD':
      return _$feeConfigRequestAgentTierEnum_STANDARD;
    case 'PREMIER':
      return _$feeConfigRequestAgentTierEnum_PREMIER;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<FeeConfigRequestAgentTierEnum>
    _$feeConfigRequestAgentTierEnumValues = BuiltSet<
        FeeConfigRequestAgentTierEnum>(const <FeeConfigRequestAgentTierEnum>[
  _$feeConfigRequestAgentTierEnum_MICRO,
  _$feeConfigRequestAgentTierEnum_STANDARD,
  _$feeConfigRequestAgentTierEnum_PREMIER,
]);
...
const FeeConfigRequestTransactionTypeEnum
    ...
    const FeeConfigRequestTransactionTypeEnum._('BILL_PAYMENT');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_JOMPAY =
    const FeeConfigRequestTransactionTypeEnum._('JOMPAY');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_ASTRO_RPN =
    const FeeConfigRequestTransactionTypeEnum._('ASTRO_RPN');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_TM_RPN =
    const FeeConfigRequestTransactionTypeEnum._('TM_RPN');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_EPF_PAYMENT =
    const FeeConfigRequestTransactionTypeEnum._('EPF_PAYMENT');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_PREPAID_TOPUP =
    const FeeConfigRequestTransactionTypeEnum._('PREPAID_TOPUP');
const FeeConfigRequestTransactionTypeEnum
...
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_SARAWAK_PAY_WITHDRAWAL =
    const FeeConfigRequestTransactionTypeEnum._('SARAWAK_PAY_WITHDRAWAL');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_SARAWAK_PAY_TOPUP =
    const FeeConfigRequestTransactionTypeEnum._('SARAWAK_PAY_TOPUP');
const FeeConfigRequestTransactionTypeEnum
...
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_CASHLESS_PAYMENT =
    const FeeConfigRequestTransactionTypeEnum._('CASHLESS_PAYMENT');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_PIN_BASED_PURCHASE =
    const FeeConfigRequestTransactionTypeEnum._('PIN_BASED_PURCHASE');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_EWALLET_WITHDRAWAL =
    const FeeConfigRequestTransactionTypeEnum._('EWALLET_WITHDRAWAL');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_EWALLET_TOPUP =
    const FeeConfigRequestTransactionTypeEnum._('EWALLET_TOPUP');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_RETAIL_SALE =
    const FeeConfigRequestTransactionTypeEnum._('RETAIL_SALE');
const FeeConfigRequestTransactionTypeEnum
    _$feeConfigRequestTransactionTypeEnum_HYBRID_CASHBACK =
    const FeeConfigRequestTransactionTypeEnum._('HYBRID_CASHBACK');
...
FeeConfigRequestTransactionTypeEnum
  ...
  switch (name) {
    ...
    case 'BILL_PAYMENT':
      return _$feeConfigRequestTransactionTypeEnum_BILL_PAYMENT;
    case 'JOMPAY':
      return _$feeConfigRequestTransactionTypeEnum_JOMPAY;
    case 'ASTRO_RPN':
      return _$feeConfigRequestTransactionTypeEnum_ASTRO_RPN;
    case 'TM_RPN':
      return _$feeConfigRequestTransactionTypeEnum_TM_RPN;
    case 'EPF_PAYMENT':
      return _$feeConfigRequestTransactionTypeEnum_EPF_PAYMENT;
    case 'PREPAID_TOPUP':
      return _$feeConfigRequestTransactionTypeEnum_PREPAID_TOPUP;
    case 'CELCOM_TOPUP':
      return _$feeConfigRequestTransactionTypeEnum_CELCOM_TOPUP;
    case 'm1TOPUP':
      return _$feeConfigRequestTransactionTypeEnum_m1TOPUP;
    case 'SARAWAK_PAY_WITHDRAWAL':
      return _$feeConfigRequestTransactionTypeEnum_SARAWAK_PAY_WITHDRAWAL;
    case 'SARAWAK_PAY_TOPUP':
      return _$feeConfigRequestTransactionTypeEnum_SARAWAK_PAY_TOPUP;
    case 'ESSP_PURCHASE':
    ...
    case 'CASHLESS_PAYMENT':
      return _$feeConfigRequestTransactionTypeEnum_CASHLESS_PAYMENT;
    case 'PIN_BASED_PURCHASE':
      return _$feeConfigRequestTransactionTypeEnum_PIN_BASED_PURCHASE;
    case 'EWALLET_WITHDRAWAL':
      return _$feeConfigRequestTransactionTypeEnum_EWALLET_WITHDRAWAL;
    case 'EWALLET_TOPUP':
      return _$feeConfigRequestTransactionTypeEnum_EWALLET_TOPUP;
    case 'RETAIL_SALE':
      return _$feeConfigRequestTransactionTypeEnum_RETAIL_SALE;
    case 'HYBRID_CASHBACK':
      return _$feeConfigRequestTransactionTypeEnum_HYBRID_CASHBACK;
    default:
      throw ArgumentError(name);
  }
}
...
Serializer<FeeConfigRequestAgentTierEnum>
    _$feeConfigRequestAgentTierEnumSerializer =
    _$FeeConfigRequestAgentTierEnumSerializer();
...
class _$FeeConfigRequestAgentTierEnumSerializer
    implements PrimitiveSerializer<FeeConfigRequestAgentTierEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[FeeConfigRequestAgentTierEnum];
  @override
  final String wireName = 'FeeConfigRequestAgentTierEnum';

  @override
  Object serialize(
          Serializers serializers, FeeConfigRequestAgentTierEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  FeeConfigRequestAgentTierEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      FeeConfigRequestAgentTierEnum.valueOf(
...
class _$FeeConfigRequestTransactionTypeEnumSerializer
  ...
  static const Map<String, Object> _toWire = const <String, Object>{
    ...
    'ASTRO_RPN': 'ASTRO_RPN',
    'TM_RPN': 'TM_RPN',
    'EPF_PAYMENT': 'EPF_PAYMENT',
    'PREPAID_TOPUP': 'PREPAID_TOPUP',
    'CELCOM_TOPUP': 'CELCOM_TOPUP',
    'm1TOPUP': 'M1_TOPUP',
    'SARAWAK_PAY_WITHDRAWAL': 'SARAWAK_PAY_WITHDRAWAL',
    'SARAWAK_PAY_TOPUP': 'SARAWAK_PAY_TOPUP',
...
class _$FeeConfigRequest extends FeeConfigRequest {
  @override
  final FeeConfigRequestAgentTierEnum agentTier;
  @override
...
class FeeConfigRequestBuilder
  ...
  FeeConfigRequestAgentTierEnum? _agentTier;
  FeeConfigRequestAgentTierEnum? get agentTier => _$this._agentTier;
  set agentTier(FeeConfigRequestAgentTierEnum? agentTier) =>
    ...
    final _$result = _$v ??
        _$FeeConfigRequest._(
          agentTier: BuiltValueNullFieldError.checkNotNull(
              agentTier, r'FeeConfigRequest', 'agentTier'),
